...
class CLICommand:
    ...
    * charge
    ...
    def add_arguments(parser):
        ...
        add("-n", "--count", action="store_true", help="Count number of selected rows.")
        add(
            "-l", "--long", action="store_true", help="Long description of selected row"
        )
        add(
            "-i",
            "--insert-into",
        ...
        add("--delete", action="store_true", help="Delete selected rows.")
        add(
            "--delete-keys",
            metavar="key1,key2,...",
            help="Delete keys for selected rows.",
        )
        add("-y", "--yes", action="store_true", help="Say yes.")
        add("--explain", action="store_true", help="Explain query plan.")
        add(
            "-c",
            "--columns",
            metavar="col1,col2,...",
        ...
        add(
            ...
            type=int,
            default=35,
            help="Cut keywords and key-value "
        ...
        add("--csv", action="store_true", help="Write comma-separated-values file.")
        add(
            "-w",
            "--open-web-browser",
            action="store_true",
        ...
        add("-m", "--show-metadata", action="store_true", help="Show metadata as json.")
        add(
            "--set-metadata",
            metavar="something.json",
        ...
        add("--show-keys", action="store_true", help="Show all keys.")
        add("--show-values", metavar="key1,key2,...", help="Show values for key(s).")
