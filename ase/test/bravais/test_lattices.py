import pytest
import numpy as np
from ase.lattice import bravais_lattices, all_variants, get_lattice_from_canonical_cell
...
@pytest.mark.parametrize("lat", list(all_variants()), ids=lambda lat: lat.variant)
