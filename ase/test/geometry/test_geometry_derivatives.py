def test_atoms_angle():
    ...
    angles_derivs = get_angles_derivatives([pos[0] - pos[1]], [pos[2] - pos[1]])[0]
    ...
    num_angles_derivs = get_numerical_derivatives(pos, mode="angle", epsilon=epsilon)
    ...
    assert (
        angles_derivs
        == get_angles_derivatives(
            [pos[0] - pos[1], pos[0] - pos[1]], [pos[2] - pos[1], pos[2] - pos[1]]
        )[0]
    ).all()
    assert (
        dihedrals_derivs
