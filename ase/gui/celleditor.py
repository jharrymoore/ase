...
class CellEditor:
    ...
    def __init__(self, gui):
        ...
        for i in [0, 1, 2]:  # x_ y_ z_
            ...
            row.append(
                ui.SpinBox(
                    mags[i], -30, 30, 0.1, self.apply_magnitudes, rounding=7, width=9
                )
            )
            ...
            self.angles.append(
                ui.SpinBox(
                    angles[i], -360, 360, 15, self.apply_angles, rounding=7, width=9
                )
            )
        ...
        win.add(
            [_("A:"), x[0], x[1], x[2], _("||A||:"), x[3], _("periodic:"), self.pbc[0]]
        )
        win.add(
            [_("B:"), y[0], y[1], y[2], _("||B||:"), y[3], _("periodic:"), self.pbc[1]]
        )
        win.add(
            [_("C:"), z[0], z[1], z[2], _("||C||:"), z[3], _("periodic:"), self.pbc[2]]
        )
        win.add(
            [
                _("∠BC:"),
        ...
        win.add(
            [
                ui.Button(_("Apply Vectors"), self.apply_vectors),
        ...
        win.add(
            [
                _(
                    "Pressing 〈Enter〉 as you enter values will "
        ...
        win.add(
            [
                ui.Button(_("Center"), self.apply_center),
    ...
    def apply_vectors(self, *args):
        ...
        atoms.set_cell(self.get_vectors(), scale_atoms=self.scale_atoms.var.get())
        self.gui.new_atoms(atoms)
