...
class GUI(View, Status):
    ...
    def step(self, key):
        d = {"Home": -10000000, "Page-Up": -1, "Page-Down": 1, "End": 10000000}[key]
    ...
    def reciprocal(self):
        ...
        kwargs = dict(cell=self.atoms.cell.uncomplete(self.atoms.pbc), vectors=True)
        ...
        return [
            ...
            (
                ...
                [
                    ...
                    M(_("_Rotate selected atoms"), self.toggle_rotate_mode, "Ctrl+R"),
                ...
                [
                    M(
                        ...
                        partial(
                            ...
                            "ASE-GUI",
                            version=__version__,
                            webpage="https://wiki.fysik.dtu.dk/" "ase/ase/gui/gui.html",
                        ),
                    ),
                    M(_("Webpage ..."), webpage),
                ],
