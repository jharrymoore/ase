...
data = {
    "Be2": {
        ...
        "symbols": "BeBe",
        "magmoms": None,
        "positions": [[0.0, 0.0, 1.0106], [0.0, 0.0, -1.0106]],
    },
    "C7NH5": {
        ...
        "magmoms": None,
        "positions": [
            [-1.593581, -1.142601, 0.0],
            [-2.235542, 0.095555, 0.0],
            [-0.204885, -1.210726, 0.0],
            [0.549645, -0.025355, 0.0],
            [1.976332, -0.085321, 0.0],
            [-0.099258, 1.220706, 0.0],
            [-1.488628, 1.273345, 0.0],
            [3.136871, -0.128138, 0.0],
            [-2.177996, -2.060896, 0.0],
            [-3.323594, 0.141242, 0.0],
            [0.301694, -2.173705, 0.0],
            [0.488716, 2.136782, 0.0],
            [-1.987765, 2.240495, 0.0],
        ],
    },
    "BDA": {
